...
def shopat(phone):
    ...
    if d == 200:
        print("[+] ShopAt24 สำเร็จ")
    else : 
        print("[-] ShopAt24 ล้มเหลว")
...
def findclone(phone):
    ...
    if d.get("Error",False) == "Wait for timeout":
        print("[-] findclone ล้มเหลว")
    else :
        print("[+] findclone สำเร็จ")
...
def unacademy(phone):
    ...
    if d.get("error_code",False):
        print("[-] unacademy ล้มเหลว")
    else :
        print("[+] unacademy สำเร็จ")
...
def instagram(phone):
    ...
    if d["status"] == "ok":
        print("[+] instagram สำเร็จ")
    else:
        print("[-] instagram ล้มเหลว")
...
def instagramv2(phone):
    ...
    if d["status"] == "ok":
        print("[+] instagram v2 สำเร็จ")
    else:
        print("[-] instagram v2 ล้มเหลว")
...
def homepro(phone):
    ...
    if d["msgtype"] == "success":
        print("[+] homepro สำเร็จ")
    else:
        print("[-] homepro ล้มเหลว")
